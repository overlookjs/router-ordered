...
const symbols = require('./symbols'),
	{IS_BEFORE, ORDER, SIBLINGS_BEFORE, SIBLINGS_AFTER} = symbols;

// Exports
function extend(Route) {
	return class RouteOrdered extends Route {
		initProps(props) {
...
function setBefore(route1, route2) {
	...
	if (route1[SIBLINGS_BEFORE].has(route2)) throw route1.debugError('Route ordering conflict');
